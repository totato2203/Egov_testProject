...
<link type="text/css" rel="stylesheet" href="/testProject/css/egovframework/com/cmm/jqueryui.css">
...
<body>
	<c:if test="${loginVO != null}">
		...
		<h1><a href="http://localhost:7080/testProject/cop/cmy/getTestList.do">전장호 테스트 페이지로 이동</a></h1>
